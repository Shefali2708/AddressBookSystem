...
namespace AddressBookSystem
{
    class Contact
    {
        ...
        internal static List<Contact> listContacts = new List<Contact>();
        internal Contact()
        {
        }
        internal Contact(string addressBookName, string firstName, string secondName, string address, string city, string state, int zip, int phoneNo, string email)
        {
        ...
        internal void AddContacts(string addressBookName)
        {
            ...
            Contact objContacts = new Contact(addressBookName, fName, sName, personAddress, personCity, personState, personZip, phoneNumber, personEmail);
        ...
        internal void EditContact(string addressBookName)
        {
            ...
            foreach (Contact item in listContacts)
            {
        ...
        internal void DeleteContact(string addressBookName)
        {
            ...
            string sName = Console.ReadLine();
            bool personFound = false;
            Contact personToDelete = new Contact();
            foreach (Contact item in listContacts)
            {
                if ((((item.firstName).ToLower() == fName.ToLower()) && ((item.secondName).ToLower() == sName.ToLower())) && item.addressBookName == addressBookName)
                {
